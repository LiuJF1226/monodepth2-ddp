...
def eval_args():
    ...
    parser.add_argument('--nyuv2_path',
                        type=str,
                        help="data path of NYU Depth v2, do not set if you do not want to evaluate on this dataset")
...
def load_model(args):
    ...
    depth_encoder = monodepth2.DepthEncoder(args.num_layers, False)
    depth_decoder = monodepth2.DepthDecoder(depth_encoder.num_ch_enc, scales=range(4))
